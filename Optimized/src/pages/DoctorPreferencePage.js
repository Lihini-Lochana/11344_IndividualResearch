...
useEffect(() => {
  trackPageVisit("DoctorPreferencePage");

  trackInteraction(
    "page_opened",
    {
      page: "DoctorPreferencePage",
    }
  );
          ...
          >
            <button
              onClick={() => {
                ...
                // 1. Count the back button
    trackBackClick("DoctorPreferencePage_back");

    // 2. Record the navigation event
    trackInteraction(
      "back_navigation",
      {
        from: "DoctorPreferencePage",
        to: "SymptomSelectionPage",
      }
    );
...
export default DoctorPreferencePage;